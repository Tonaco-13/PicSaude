...
\textit{B. Document integrity (tamper-evidence).} For the canonical document, the SHA-256 digest was identical across 1{,}000 recomputations of the same input (determinism), and a single-field mutation altered the digest for all 12 document fields (7 header, 5 per item)---i.e., any content change is tamper-evident.
...
\hline
Hash tamper-evidence & deterministic over 1{,}000 runs; 12/12 fields alter the digest \\
\hline
